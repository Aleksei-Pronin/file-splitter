package ru.shiftproject.pronin.splitter.statistics.updater;
...
import ru.shiftproject.pronin.splitter.statistics.collector.StatisticsCollectorCreator;
...
public class StatisticsUpdater {
    ...
    public void update(DataType dataType, String line) {
        if (configuration.shouldPrintStatistics()) {
            ...
            statisticsCollectorsByType.get(dataType).process(line);
        }
    }
}